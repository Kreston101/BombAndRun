...
{
    public GameObject pillar, plane, landingPlane;
    ...
    void Start()
    {
        ...
        {
            obstacles.Add(Instantiate(pillar, spawnPoints[i].transform.position, transform.rotation));
        }
        ...
        bombingScript.SetNumBombs(5, 10);

        level.text = $"Level {levelNumber}";

        //adds a 3 second delay to the start of the level
